...
`
  ...
  static Label = `
<svg class="task-priority-svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
  stroke="var(--task-blue-clr)" data-color="blue">
  <path stroke-linecap="round" stroke-linejoin="round"
...
`
  ...
  static Circle12_5 = `
  <svg viewBox="0 0 24 24" fill="none" >
  <path d="M12 3C13.1819 3 14.3522 3.23279 15.4442 3.68508C16.5361 4.13738 17.5282 4.80031 18.364 5.63604L12 12L12 3Z" fill="${Icon.defaultColor}"/>
  <circle cx="12" cy="12" r="9" transform="rotate(-90 12 12)" stroke="${Icon.defaultColor}" stroke-width="2"/>
  </svg>
`
  ...
  static Circle25 = `
  <svg viewBox="0 0 24 24" fill="none" >
  <path d="M12 3C13.1819 3 14.3522 3.23279 15.4442 3.68508C16.5361 4.13738 17.5282 4.80031 18.364 5.63604C19.1997 6.47177 19.8626 7.46392 20.3149 8.55585C20.7672 9.64778 21 10.8181 21 12L12 12L12 3Z" fill="${Icon.defaultColor}"/>
  <circle cx="12" cy="12" r="9" transform="rotate(-90 12 12)" stroke="${Icon.defaultColor}" stroke-width="2"/>
  </svg>
`
  ...
  static Circle37_5 = `
  <svg viewBox="0 0 24 24" fill="none" >
  <path d="M12 3C13.78 3 15.5201 3.52784 17.0001 4.51677C18.4802 5.50571 19.6337 6.91131 20.3149 8.55585C20.9961 10.2004 21.1743 12.01 20.8271 13.7558C20.4798 15.5016 19.6226 17.1053 18.364 18.364L12 12L12 3Z" fill="${Icon.defaultColor}"/>
  <circle cx="12" cy="12" r="9" transform="rotate(-90 12 12)" stroke="${Icon.defaultColor}" stroke-width="2"/>
  </svg>
`
  ...
  static Circle50 = `
  <svg viewBox="0 0 24 24" fill="none" >
  <path d="M12 3C14.3869 3 16.6761 3.94821 18.364 5.63604C20.0518 7.32387 21 9.61305 21 12C21 14.3869 20.0518 16.6761 18.364 18.364C16.6761 20.0518 14.3869 21 12 21L12 12L12 3Z" fill="${Icon.defaultColor}"/>
  <circle cx="12" cy="12" r="9" transform="rotate(-90 12 12)" stroke="${Icon.defaultColor}" stroke-width="2"/>
  </svg>
`
